...
public class FormDateCell: FormValueCell {
    ...
    public override func update() {
        ...
        if rowDescriptor.value != nil {
            ...
            let date = rowDescriptor.value as! String
            let timeFo   = NSDateFormatter()
            timeFo.dateFormat = "yyy-MM-dd HH:mm"
            datePicker.date = timeFo.dateFromString(date)!
    ...
    public override class func formViewController(formViewController: FormViewController, didSelectRow selectedRow: FormBaseCell) {
        ...
        if row.rowDescriptor.value == nil {
            ...
            let timeFo   = NSDateFormatter()
            timeFo.dateFormat = "yyy-MM-dd HH:mm"
            row.rowDescriptor.value = timeFo.stringFromDate(date)
    ...
    internal func valueChanged(sender: UIDatePicker) {
        let timeFo   = NSDateFormatter()
        timeFo.dateFormat = "yyy-MM-dd HH:mm"
        rowDescriptor.value = timeFo.stringFromDate(sender.date)
